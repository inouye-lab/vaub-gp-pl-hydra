...
class UnPairedImageDatasetMulti(Dataset):
    def __init__(self, dataset_list: List[Dataset], counter: int):
        ...
        self.dataset_size = max([len(dataset) for dataset in dataset_list])
        self.rand_idx_list = [np.random.permutation(len(dataset)) for dataset in dataset_list]
